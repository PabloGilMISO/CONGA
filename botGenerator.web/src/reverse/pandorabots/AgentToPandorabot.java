...
import reverse.dialogflow.agent.intents.Context;
import reverse.dialogflow.agent.intents.Data;
import reverse.dialogflow.agent.intents.Message;
import reverse.dialogflow.agent.intents.Prompt;
...
public class AgentToPandorabot {
	...
	private UserInteraction getInteractionFlow(reverse.dialogflow.agent.intents.Intent intent, Bot bot) {
	...
	private List<Action> actionConversor(reverse.dialogflow.agent.intents.Intent intent, Bot bot) {
	...
	private Intent intentConversor(reverse.dialogflow.agent.intents.Intent intent, Bot bot) {
		...
		for (reverse.dialogflow.agent.intents.Response responses : intent.getResponses()) {
			for (reverse.dialogflow.agent.intents.Parameter param : responses.getParameters()) {
	...
	private Parameter parameterConversor(reverse.dialogflow.agent.intents.Parameter param, Bot bot) {
	...
	private Entity entityConversor(reverse.dialogflow.agent.entities.Entity entity) {
